...
class TransitionsControllerTest < ActionController::TestCase
  ...
  test "should create transition" do
    assert_difference('Transition.count') do
      post :create, transition: { TransitionID: @transition.TransitionID, TransitionName: @transition.TransitionName }
    end
  ...
  test "should update transition" do
    patch :update, id: @transition, transition: { TransitionID: @transition.TransitionID, TransitionName: @transition.TransitionName }
    assert_redirected_to transition_path(assigns(:transition))
  end
